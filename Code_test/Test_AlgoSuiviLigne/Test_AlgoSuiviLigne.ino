...
// #include "AlgoRobotPutter.h"  // inclusion après définition des constante prepoc
...
void loop() 
{
  ...
  while (bIsOnT == 0)
  {
      ...
      // Serial.print(sSensorIR.bC1IsOnTheLine);
      // Serial.print(sSensorIR.bC2IsOnTheLine);
      // Serial.print(sSensorIR.bC3IsOnTheLine);
      // Serial.println("");
      // delay(1000);
       sSensorIR = oCapteurIR.sReadLineSensors();
