...
/**
 * @fn void vMotorDriverInit(uint16_t u16DirPinL, uint16_t u16PwmPinL, 
 ...
 * @note Cette fonction doit être appelée avant d'utiliser les moteurs
 */
/** @callgraph */
/** @callergraph */
...
/**
 * @fn void vSetMotor(uint16_t u16MotorID, MotorDirection eDirection, uint16_t u16Speed)
...
/**
 * @fn void vStopMotor(uint16_t u16MotorID)
 * @brief Arrête un moteur
 * @param u16MotorID Identifiant du moteur à arrête  
 */
/** @callgraph */
/** @callergraph */
